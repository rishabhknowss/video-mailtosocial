  ...
  return (
    <AppLayout>
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-2">Train Your Voice Model</h1>
        ...
        <div className="flex items-center mb-8">
          ...
          <div className="flex items-center">
            ...
            <span className="ml-2 font-medium">Train Voice</span>
          </div>
          <div className="flex-1 h-0.5 mx-4 bg-gray-300"></div>
          <div className="flex items-center">
            ...
            <span className="ml-2 text-gray-600">Create Video</span>
          </div>
        </div>
        ...
        {!isVideoUploaded ? (
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-medium text-yellow-800">Video Upload Required</h3>
            </div>
            ...
            {userProfile?.voice_id && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-medium text-green-800">Voice Model Trained Successfully!</h3>
                </div>
